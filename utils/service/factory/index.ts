...
const getFactory = async (): Promise<Factory[]> => {
  ...
  if (apiRes.ok !== true)
    throw new Error("An error occurred when fetching factory");
...
const getFactoryById = async (id: string): Promise<Factory> => {
  ...
  if (!apiRes.ok)
    throw new Error("An error occurred when fetching factory by id");
...
const deleteFactory = async ({ id }: Factory): Promise<boolean> => {
  ...
  if (apiRes.ok !== true)
    throw new Error("An error occurred when deleting factory");
...
const createFactory = async (values: Factory): Promise<boolean> => {
  ...
  if (!apiRes.ok) {
    ...
    throw new Error(
      `An error occurred when creating factory: ${
...
const updateFactory = async (values: Factory): Promise<boolean> => {
  ...
  if (apiRes.ok !== true)
    throw new Error("An error occurred when updating factory.");
