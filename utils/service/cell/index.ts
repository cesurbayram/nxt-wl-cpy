...
const getCell = async (): Promise<Cell[]> => {
  ...
  if (apiRes.ok !== true)
    throw new Error("An error occurred when fetching cells");
...
const deleteCell = async ({ id }: Cell): Promise<boolean> => {
  ...
  if (apiRes.ok !== true)
    throw new Error("An error occurred when deleting cell");
...
const createCell = async (values: Cell): Promise<boolean> => {
  ...
  if (!apiRes.ok) {
    ...
    throw new Error(
      `An error occurred when creating cell: ${
...
const updateCell = async (values: Cell): Promise<boolean> => {
  ...
  if (apiRes.ok !== true)
    throw new Error("An error occurred when updating cell.");
